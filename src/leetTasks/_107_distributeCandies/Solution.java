package leetTasks._107_distributeCandies;

import java.util.Arrays;

/*
lice has n candies, where the ith candy is of type candyType[i]. Alice noticed that she started to gain weight,
...
public class Solution {
    ...
    public  static int distributeCandies(int[] candyType) {
     int uniqCandies = (int) Arrays.stream(candyType).distinct().count();
     int allowedCandies = candyType.length/2;
     return Math.min(uniqCandies, allowedCandies);
    }
